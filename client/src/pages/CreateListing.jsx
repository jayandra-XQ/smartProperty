        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input type="number" id="bedrooms" min="1" max="10" required onChange={handleChange}
                value={formData.bedrooms} />
              <p>Beds</p>
            </div>

            <div className="flex items-center gap-2">
              <input type="number" id="bathrooms" min="1" max="10" requiredonChange={handleChange}
            ...
            <div className="flex items-center gap-2">
              <input type="number" id="regularPrice" min='50'
                max='10000000' required onChange={handleChange}
            ...
            <div className="flex items-center gap-2">
              <input type="number" id="discountPrice" min='50'
                max='10000000' required onChange={handleChange}
